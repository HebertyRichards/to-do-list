...
export function ProfileSection({ username, avatarUrl }: { username: string; avatarUrl: string }) {
  ...
  return (
    <SettingsSection title="Perfil" description="Atualize seu nome de usuário e avatar.">
      ...
      <form onSubmit={onSubmit} className="space-y-4">
        <LabeledInput label="Nome de usuário" error={errors.username?.message} {...register("username")} />
        <LabeledInput
